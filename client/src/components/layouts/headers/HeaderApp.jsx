                ...
                >
                  ...
                  <Menu.Item className="border-b-[1px]">
                        <p className={classNames('truncate px-3.5 py-3')}>
                          <span className={classNames('block text-xs text-gray-500')} role="none">Signed in as</span>
                          <span className={classNames('mt-0.5 font-semibold text-sm')} role="none">{authUser.emailAddress}</span>
                        </p>
                    </Menu.Item>
                    <Menu.Item>
                      {({ active }) => (
