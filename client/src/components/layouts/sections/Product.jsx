        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg dark:text-slate-300">
              ...
              <ul role="list" className="mt-8 space-y-8 text-gray-600 dark:text-gray-300">
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    Satoshi&apos;s user-friendly interface, generating invoices
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    Satoshi ensures your sensitive information is protected with
                ...
                <li className="flex gap-x-3">
                  ...
                  <span>
                    ...
                    your clients. Spend less time chasing invoices and more time
                    doing what you love.
                  </span>
                </li>
              </ul>
              <p className="mt-8">
                Take your invoicing wherever you go with Satoshi&apos;s free
              ...
              <p className="mt-6">
                Enjoy the simplicity of invoicing without any cost. With
                Satoshi&apos;s user-friendly interface, generating invoices is
                as easy as a few clicks, and it&apos;s always free.
              </p>
            </div>
          </div>
        </div>
